...
class BadmintonKRPtWidget extends StatefulWidget {
  const BadmintonKRPtWidget({Key? key}) : super(key: key);

  @override
  _BookingCourtWidgetState createState() => _BookingCourtWidgetState();
}

class _BookingCourtWidgetState extends State<BadmintonKRPtWidget> {
  late BadmintonKRPModel _model;
